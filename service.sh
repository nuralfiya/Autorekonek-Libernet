...
function start_services() {
  ...
  "${LIBERNET_DIR}/bin/log.sh" -w "<span style=\"color: blue\">Ø§Ù„Ø­Ù…Ø¯ Ù„Ù„Ù‡ Ø±Ø¨ Ø§Ù„Ø¹Ø§Ù„Ù…ÙŠÙ†</span>"
  # write libernet to service log
  "${LIBERNET_DIR}/bin/log.sh" -w "<span style=\"color: blue\">niceee... Konek Mbahhh</span>"
...
echo -e "Libernet auto start + auto rekonek enabled!"
}
